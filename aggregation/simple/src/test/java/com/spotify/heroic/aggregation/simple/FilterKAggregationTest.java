...
public class FilterKAggregationTest {
    ...
    public void testFilterKSession() {
        ...
        final TopKInstance t1 = new TopKInstance(2);
        final BottomKInstance b1 = new BottomKInstance(1);

        final ChainInstance chain = new ChainInstance(
            Optional.of(ImmutableList.of(g1, g2, t1, b1)));
        ...
        if (first.getGroup().equals(ImmutableMap.of("site", "lon"))) {
            assertEquals(ImmutableList.of(new Point(3, 3.0)), first.getMetrics().getData());
