...
public class BottomKInstance implements AggregationInstance {
    private final FilterKInstance filterK;

    public BottomKInstance(long k) {
        filterK = new FilterKInstance(k, FilterKInstance.FilterType.BOTTOM);
    }
